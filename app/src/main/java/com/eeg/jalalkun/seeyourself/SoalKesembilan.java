...
public class SoalKesembilan extends AppCompatActivity {

    private Button selanjutnya;
    private RadioButton radioButton;
    private RadioGroup radioGroup;
    private Bundle bundle;
    private String d1,d2,d3,d4,d5,d6,d7,d8,d9,nama;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selanjutnya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SoalKesembilan.this,SoalKesepuluh.class);
                int selectedId = radioGroup.getCheckedRadioButtonId();
                radioButton=(RadioButton)findViewById(selectedId);
                d9 = radioButton.getText().toString();
